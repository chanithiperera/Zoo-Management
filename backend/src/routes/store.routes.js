...
router.post('/products', protect, restrictTo('admin'), storeController.createProduct);
router.put('/products/:id', protect, restrictTo('admin'), storeController.updateProduct);
